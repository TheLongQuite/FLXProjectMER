...
public static class ReflectionExtensions
{
    ...
    public static IEnumerable<string> GetColoredProperties(this List<PropertyInfo> properties, object instance)
    {
        foreach (PropertyInfo property in properties)
        {
            ...
            {
                yield return $"{property.Name}: {((bool)property.GetValue(instance) ? "<color=green><b>TRUE</b></color>"
            ...
            else if (property.Name.Contains("Color"))
            {
                ...
                yield return $"{property.Name}: <color={colorString.GetColorFromString().ToHex()}><b>{colorString
                }</b></color>";
            }
