...
public class SerializablePlayerSpawnpoint : SerializableObject, IIndicatorDefinition
{
    ...
    public GameObject SpawnOrUpdateIndicator(Room room, GameObject? instance = null)
    {
        ...
        if (instance == null)
        {
            ...
            cylinder.transform.localScale = new(1f, 0.001f, 1f);
        ...
        foreach (PrimitiveObjectToy primitive in root.GetComponentsInChildren<PrimitiveObjectToy>())
        {
            if (Roles.Count > 0)
            {
                ...
                primitive.NetworkMaterialColor = new(colorSum.r / Roles.Count, colorSum.g / Roles.Count,
                    colorSum.b / Roles.Count, colorSum.a);
            }
            else
